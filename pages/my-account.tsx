...
const ProfilePage = () => {
  ...
  const handleOnFinish = async ({ firstName, lastName, phoneNumber }: IUser) => {
    setBtnLoading(true);
    try {
        await updateProfile({
            id: currentUser?.id || 0,
    ...
    return (
        <div>
            ...
            />
            {
                !isLoading ?
                isEmpty(currentUser) ? 
                <NoData title="No Account Available" subTitle={
                    (
                        <div>
                            You must be sign in to see your personal information, Let's click <span className="cursor-pointer" style={{ color: "#0084ff", textDecoration: "underline" }}>here</span> to sign in
                        </div>
                    )
                } className="mt-40"/>
                :
                    ...
                    <div className="max-w-md w-full space-y-8">
                        <div>
                            <img
                                ...
                                alt="Workflow"
                            />
                            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Your personal account</h2>
                        </div>
                            ...
                            >
                                <Form.Item
                                    ...
                                    hasFeedback
                                    >
                                    <Input name="firstName" onChange={(e) => {handleOnChangeInput(e)}}/>
                                </Form.Item>
                                <Form.Item
                                    name="lastName"
                                    label="Last Name"
                                    ...
                                    hasFeedback
                                    >
                                    <Input name="lastName" onChange={(e) => {handleOnChangeInput(e)}}/>
                                </Form.Item>
                                <Form.Item
                                    name="phoneNumber"
                                    label="Phone Number"
                                    ...
                                    hasFeedback
                                    >
                                    <Input name="phoneNumber" onChange={(e) => {handleOnChangeInput(e)}} style={{ width: "100%" }} />
                                </Form.Item>
                                <Form.Item
                                    name="email"
                                    label="E-mail"
                                ...
                                <Button
                                    ...
                                    style={{
                                        height: "37.6px",
                                        background: isDisabledSave ? "#ccc" : "var(--radial-gradient-orange-4)",
                                    }}
