    ...
    return (
        <div className="flex flex-col justify-between">
            ...
            <div className="tch-detail-sale-box flex flex-col items-center">
                <h4 className="tch-detail-sale-box-title mb-1">
                    {voucherRef.nameVoucher}
                </h4>
                <p className="tch-text-expired-time" color="#D2691E">
                    Expired in {diffThanCurrentDate(voucherRef.dateExpired)}{" "}
                    days
                </p>
                <img
                    src={voucher.imageUrl}
                    className="tch-detail-sale-box-image"
                />
                <span className="tch-text-user-info mb-0">
                    ...
                    <CopyFilled
                        ...
                        style={{ color: "#ff792c" }}
                        onClick={() => handleOnClickCopy(voucherRef.code)}
                    />
                </span>
                <span
                    className="text-center tch-text-user-info"
                    style={{ color: "#777" }}
                >
